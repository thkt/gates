...
バイナリのインストールとPostToolUseフックの登録が自動で行われます。
...
| **gates**                                        | PostToolUse | Write/Edit 後           | 品質ゲート                    |
